...
assert player["defaults"] == {
    "hair": "hair6w", "eyes": "eye15", "mouth": "mouth1",
    "skinColor": "#FFB985", "hairColor": "#000000", "clothColor": "#009B0C",
}
assert len(player["options"]["hair"]) == 15
assert len(player["options"]["eyes"]) == 18
...
print("Player color masks, 27 shared expression parts, and portrait layers passed")
